...
export FF_DRIVER_NAME=cxxfilt
export SRC_DIR=/benchmark/binutils-2.30

tar xzf /benchmark/source/binutils-2.30.tar.gz -C /benchmark
...
cd && rm -r $SRC_DIR/ && tar xzf /benchmark/source/binutils-2.30.tar.gz -C /benchmark
