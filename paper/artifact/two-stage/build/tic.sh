...
export FF_DRIVER_NAME=tic
export SRC_DIR=/benchmark/ncurses-6.2

tar xzf /benchmark/source/ncurses-6.2.tar.gz -C /benchmark
...
cd && rm -r $SRC_DIR/ && tar xzf /benchmark/source/ncurses-6.2.tar.gz -C /benchmark
