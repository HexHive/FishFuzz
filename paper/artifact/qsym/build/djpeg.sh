...
export FF_DRIVER_NAME=djpeg
export SRC_DIR=/benchmark/jpeg-9c
export __FF_ONLY_UBSAN=1
export USE_UBSAN_LABEL=1

tar xzf /benchmark/source/jpegsrc.v9c.tar.gz -C /benchmark
...
# build afl binary
cd && rm -r $SRC_DIR/ && tar xzf /benchmark/source/jpegsrc.v9c.tar.gz -C /benchmark
