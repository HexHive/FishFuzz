...
export FF_DRIVER_NAME=tcpdump
export SRC_DIR=/benchmark/tcpdump-4.9.2
export __FF_ONLY_UBSAN=1
export USE_UBSAN_LABEL=1

tar xzf /benchmark/source/tcpdump-4.9.2.tar.gz -C /benchmark
...
export EXTRA_LDFLAGS="-ldl -lpthread -lrt -lm -lubsan -lpcap"
...
cd && rm -r $SRC_DIR/ && tar xzf /benchmark/source/tcpdump-4.9.2.tar.gz -C /benchmark
