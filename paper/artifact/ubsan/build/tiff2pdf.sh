...
export FF_DRIVER_NAME=tiff2pdf
export SRC_DIR=/benchmark/tiff-4.0.10
export __FF_ONLY_UBSAN=1
export USE_UBSAN_LABEL=1

tar xzf /benchmark/source/tiff-4.0.10.tar.gz -C /benchmark
...
cd && rm -r $SRC_DIR/ && tar xzf /benchmark/source/tiff-4.0.10.tar.gz -C /benchmark
