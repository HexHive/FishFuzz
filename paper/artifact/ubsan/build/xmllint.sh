...
export FF_DRIVER_NAME=xmllint
export SRC_DIR=/benchmark/libxml2-2.9.7
export __FF_ONLY_UBSAN=1
export USE_UBSAN_LABEL=1

tar xzf /benchmark/source/libxml2-2.9.7.tar.gz -C /benchmark
...
export EXTRA_LDFLAGS="-ldl -lpthread -lrt -lm -lubsan -lz"
...
cd && rm -r $SRC_DIR/ && tar xzf /benchmark/source/libxml2-2.9.7.tar.gz -C /benchmark
