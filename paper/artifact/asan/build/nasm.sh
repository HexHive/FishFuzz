...
export FF_DRIVER_NAME=nasm
export SRC_DIR=/benchmark/nasm-2.14rc4

tar xzf /benchmark/source/nasm-2.14rc4.tar.gz -C /benchmark
...
cd && rm -r $SRC_DIR/ && tar xzf /benchmark/source/nasm-2.14rc4.tar.gz -C /benchmark
