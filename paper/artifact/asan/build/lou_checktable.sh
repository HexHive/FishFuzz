...
export FF_DRIVER_NAME=lou_checktable
export SRC_DIR=/benchmark/liblouis-3.7.0

tar xzf /benchmark/source/liblouis-3.7.0.tar.gz -C /benchmark
...
cd && rm -r $SRC_DIR/ && tar xzf /benchmark/source/liblouis-3.7.0.tar.gz -C /benchmark
