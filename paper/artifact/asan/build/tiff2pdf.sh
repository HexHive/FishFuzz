...
export SRC_DIR=/benchmark/tiff-4.0.9

tar xzf /benchmark/source/tiff-4.0.9.tar.gz -C /benchmark
...
cd && rm -r $SRC_DIR/ && tar xzf /benchmark/source/tiff-4.0.9.tar.gz -C /benchmark
