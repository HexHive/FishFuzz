...
export FF_DRIVER_NAME=flvmeta
export SRC_DIR=/benchmark/flvmeta-1.2.1

tar xzf /benchmark/source/v1.2.1.tar.gz -C /benchmark
...
cd && rm -r $SRC_DIR/ && tar xzf /benchmark/source/v1.2.1.tar.gz -C /benchmark
