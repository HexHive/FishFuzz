...
export FF_DRIVER_NAME=MP4Box
export SRC_DIR=/benchmark/gpac-0.7.1

tar xzf /benchmark/source/v0.7.1.tar.gz -C /benchmark
...
cd $SRC_DIR && ./configure --disable-shared --static-mp4box && make -j$(nproc)
...
cd && rm -r $SRC_DIR/ && tar xzf /benchmark/source/v0.7.1.tar.gz -C /benchmark
